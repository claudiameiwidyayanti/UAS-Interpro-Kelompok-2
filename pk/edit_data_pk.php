...
<title>Edit Data PK</title>
</head>
<body>
<div>
<form action="update_data_pk.php" method="post">
<?php
$id = $_GET['NIM'];
...
<table>
         <thead>
         <tr><th colspan="3">Edit Data PK: <?php echo $data['nama_pk']?></th></tr>
         </thead>
         <tr>
...
<a href="halaman_pk.php"><button id="tombolformback" class="button">Kembali</button></a>
</div>
</body></html>