                      ...
                      <table>
                          ...
                          <?php
                            ...
                            ?>
                                <tr>
                                    <td><?php echo $i?></td>
                                    <td><?php echo $row3['ID_JURNAL']?></td>
                                    <td><?php echo $row3['PERTEMUAN']?></td>
                                    <td>
                                    <?php 
                                    $n=$row3['ID_JURNAL'];
                                    $kehadiran=mysql_query("select * from jurnal where ID_JURNAL='$n'");
                                    $cek=mysql_fetch_row($kehadiran);
                                    if ($cek==1) {
                                    $status_hadir=mysql_fetch_array($kehadiran);
                                    echo $status_hadir['keterangan'];}
                                    else {echo 'belum hadir';}?></td>
